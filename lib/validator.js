 ...
 * @returns {boolean|Error}
 */
const genericCompareBuffer = (buffer, bufferType) => {
    checkBuffer(buffer);
    return Buffer.compare(bufferType, buffer.subarray(0, bufferType.length)) == 0;
}

const isPng = (buffer) => {
    genericCompareBuffer(buffer, s.PNG);
};

const isAvif = (buffer) => {
    genericCompareBuffer(buffer, s.AVIF);
};

const isBmp = (buffer) => {
    genericCompareBuffer(buffer, s.BMP);
};

const isDib = (buffer) => {
    genericCompareBuffer(buffer, s.DIB);
};

const isGif = (buffer) => {
    genericCompareBuffer(buffer, s.GIF);
};

const isTiff = (buffer) => {
    genericCompareBuffer(buffer, s.TIFF);
};

const isMp3 = (buffer) => {
    genericCompareBuffer(buffer, s.MP3);
};
...
const isFlv = (buffer) => {
    genericCompareBuffer(buffer, s.FLV);
};

const isApk = (buffer) => {
    genericCompareBuffer(buffer, s.APK);
};

const isMsOffice = (buffer) => {
    genericCompareBuffer(buffer, s.MS_OFFICE);
};

const isJar = (buffer) => {
    genericCompareBuffer(buffer, s.JAR);
};

const isSwf = (buffer) => {
    genericCompareBuffer(buffer, s.SWF);
};

const isJpeg = (buffer) => {
    genericCompareBuffer(buffer, s.JPEG);
};
...
const isMkv = (buffer) => {
    genericCompareBuffer(buffer, s.MKV);
};

const isPdf = (buffer) => {
    genericCompareBuffer(buffer, s.PDF);
};

const isRar = (buffer) => {
    genericCompareBuffer(buffer, s.RAR);
};

const isGzip = (buffer) => {
    genericCompareBuffer(buffer, s.GZIP);
};
...
const isWebp = (buffer) => {
    genericCompareBuffer(buffer, s.WEBP);
};
